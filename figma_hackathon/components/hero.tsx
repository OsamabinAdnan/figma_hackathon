                ...
                <div className='flex justify-between items-center gap-2 m-0  lg:flex-row flex-col '>
                    <div className='relative lg:w-[680px] md:w-[475px] max-h-[380px] bg-[#54a6ff] p-4 rounded '>
                        <div className=' flex flex-col max-w-[284px] gap-4'>
                            ...
                            <Button onClick={()=>route.push('/category')} className='bg-PrimaryBlue w-[120px] h-[44px] text-white px-5 py-2 rounded'>Rental Car</Button>
                        </div>
                        <div className='flex items-center justify-center'>
                            <Image src='/hero-car-1.png' alt='car' width={426} height={116}/>
                        </div>
                    </div>
                    <div className='relative lg:w-[680px] md:w-[475px] max-h-[380px] bg-PrimaryBlue p-4 rounded md:block hidden '>
                        <div className=' flex flex-col max-w-[284px] gap-4'>
